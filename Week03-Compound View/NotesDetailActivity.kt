...
class NotesDetailActivity : AppCompatActivity() {
    ...
    private lateinit var titleAndContentView: TitleAndContentView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        titleAndContentView = findViewById(R.id.title_and_content_view)
...
//        contentsView.setText(note?.content, TextView.BufferType.EDITABLE)
        ...
        titleAndContentView.setTitleAndContent(note?.title, note?.content)
...
//                this.note.listOfLabels = list as ArrayList<Label>
    ...
    override fun onPause() {
        ...
        newNote.title = titleAndContentView.getTitleView().text.toString()
        newNote.content = titleAndContentView.getContentView().text.toString()
...
//            overridePend
        ...
        R.id.item_notes_details_pin ->{
            if(note.isPinned){
                if(notesOperationHandler.unPinNote(note)){
                    println("un pinned successfully")
                }
                else
                    println("un pinned fails")
            }
            else{
